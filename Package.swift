...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AppSpectorSDK",
            url: "https://maven.appspector.com/artifactory/ios-sdk/1.4.0/AppSpectorSDK-1.4.0.xcframework.zip",
            checksum: "fdb32272dc4a5b696c9e035f1edcd3e0150535d5f1681271e86328c0d8140cce"
        ),
        .binaryTarget(
            name: "AppSpectorTVSDK",
            url: "https://maven.appspector.com/artifactory/ios-sdk/1.4.0/AppSpectorTVSDK-1.4.0.xcframework.zip",
