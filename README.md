...
To manually link just download [AppSpectorSDK.framework.zip](https://github.com/appspector/ios-sdk/blob/master/AppSpectorSDK.framework.zip?raw=true), extract it and drop AppSpectorSDK.framework to your XCode project.
