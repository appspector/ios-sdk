...
You can find an example plist file [here](https://github.com/appspector/ios-sdk/blob/master/AppSpector.plist). Simply copy it to your project and modify the keys as needed.
